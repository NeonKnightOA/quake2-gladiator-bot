...
CFLAGS=$(BASE_CFLAGS) -mtune=i586 -O6 -ffast-math -funroll-loops \
...
DO_CC=$(CC) $(CFLAGS) $(LDFLAGS) $(SHLIBCFLAGS) -o $@ -c $<
...
GAME_OBJS = \
	...
	p_client.o p_hud.o p_lag.o p_menu.o p_menulib.o p_trail.o\
